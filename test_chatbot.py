"""
Comprehensive chatbot test - Full end-to-end analysis.

Takes natural language input, runs complete research analysis, and returns detailed output.
Test the entire flow: chatbot → research → recommendations.
"""
...
def display_research_findings(research_data: dict):
    """Display complete research insights and analysis"""
    ...
    for sector_name, sector_data in sectors.items():
        ...
        if "error" not in news and news:
            ...
            for idx, risk_item in enumerate(risks[:3], 1):
...
async def run_comprehensive_test():
    """Run complete end-to-end test: chatbot → research → output"""
    
    print("="*80)
    print("COMPREHENSIVE CHATBOT TEST")
    print("="*80)
    print("This test will:")
    print("  1. Collect your investment preferences via chatbot")
    print("  2. Run full research analysis across all selected sectors")
    print("  3. Display detailed findings and recommendations")
    print("\nYou can use natural language or numbers for all inputs.\n")
    ...
    # Step 2: Run full research analysis
    ...
    try:
        ...
        print(f"Running comprehensive analysis on {len(sectors)} sectors...")
        ...
        # Step 3: Display detailed output
        display_research_findings(research)
        
        print("\n" + "="*80)
        print("COMPREHENSIVE TEST COMPLETE ✓")
        print("="*80)
        print(f"\nAnalyzed {len(sectors)} sectors with {len(goals) if goals else 0} investment goals")
        print("All research findings displayed above.")
